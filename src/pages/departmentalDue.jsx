...
const DeptDue = () => {
  ...
  const departmentDues = {
    // The first word in the dept names : the dept dues
    agricultural: 1000,
    civil: 800,
    electrical: 1200,
    mechanical: 1000,
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit: (values) => {
      const departmentKey = formik.values.dept.split(" ")[0].toLowerCase();
      const config = {
        public_key: "FLWPUBK_TEST-07ab91ac907ce1bf4494bdd14ed7c677-X",
        tx_ref: Date.now().toString(),
        amount: departmentDues[departmentKey] || 0,
        currency: "NGN",
        ...
        <div className="inputFields">
          ...
          <div>
            ...
            <select
              ...
              className={
                formik.errors.level && formik.touched.level ? "input-error" : ""
              }
            >
